...
/*~*~*~*~*~*~*~*~*~*~*~*~ SPI CONFIG *~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*/
      ...
      #define mac_enc_spi_tris_init()  *0xF93=*0xF93 | 3; *0xF94 = (*0xF94 & 0b11010111) | 0x10; *0xF95=*0xF95 & 0xFC
...
/*
//this is buggy according to errata sheet
...
#define ENC_MAC_RX_START   0
#define ENC_MAC_RX_END     ENC_MAC_RX_SIZE
#define ENC_MAC_TX_START   ((int16)ENC_MAC_RX_SIZE+1)
#define ENC_MAC_TX_END     8191
...
void NICPutHeader(ETHERNET_HEADER *header) {
   ...
   enc_mac_write_bytes(0x7A, header, sizeof(ETHERNET_HEADER));
}
