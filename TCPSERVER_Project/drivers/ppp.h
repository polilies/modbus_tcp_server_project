...
#ifndef PPP_LCP_USE_ASYNC_MAP
   #define PPP_LCP_USE_ASYNC_MAP   FALSE
#endif
...
#IF PPP_LCP_USE_PAP
 int1 ppp_isp_has_pap;
// int1 ppp_isp_ask_pap;
 char * ppp_pap_password;
 char * ppp_pap_username;
#ENDIF

#IF PPP_LCP_USE_ASYNC_MAP
   int8 ppp_async_map[32];
   int1 ppp_use_async_map;
   int1 ppp_attempt_async_map;
   int1 ppp_async_map_new;
#ENDIF
